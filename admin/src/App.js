            ...
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/">
                        ...
                        <Route path="hotels">
                            <Route index element={<ProtectedRoute><List cloumns={hotelColumns} /></ProtectedRoute>} />
                        ...
                        <Route path="rooms">
                            <Route
                                index
                                element={<ProtectedRoute><List cloumns={roomColumns} /></ProtectedRoute>} />
                            <Route path=":productId" element={<ProtectedRoute><Single /></ProtectedRoute>} />
                            <Route
                                path="new"
